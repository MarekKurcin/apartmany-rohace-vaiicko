...
class Configuration
{
    ...
    public const DB_NAME = 'apartmany_rohace'; // Database name (defined in docker/.env)
    public const DB_USER = 'apartmany_user'; // Username for database access (defined in docker/.env)
    public const DB_PASS = 'admin'; // Password for database access (defined in docker/.env)
